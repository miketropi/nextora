...
(() => {
  ...
  // wp-external:@wordpress/compose
  var require_compose = __commonJS({
    "wp-external:@wordpress/compose"(exports, module) {
  ...
  function buildFontStyle(fontFamily) {
  ...
  function isContentSelection(startPoint, endPoint, blockClientId) {
  ...
  function getSelectionOffset(point) {
  ...
  function HeadingFontToolbar({
    ...
    const { hasSelection, start, end } = (0, import_data.useSelect)(
      (select) => {
        if (!isSelected) {
        ...
        if (startOffset === null || endOffset === null || !isContentSelection(startPoint, endPoint, clientId) || startOffset === endOffset) {
          return { hasSelection: false, start: 0, end: 0 };
        }
        return {
          hasSelection: true,
    ...
    const applyFont = (font) => {
      ...
      const nextValue = (0, import_rich_text.applyFormat)(
        value,
        {
          type: FORMAT_NAME,
          attributes: {
      ...
      setAttributes({
        content: (0, import_rich_text.toHTMLString)({ value: nextValue })
      });
    };
  ...
  var withHeadingFontToolbar = (0, import_compose.createHigherOrderComponent)(
    (BlockEdit) => {
      return (props) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadingFontToolbar, { ...props }),
