...
(() => {
  ...
  var FALLBACK_COLORS = [
    ...
    { name: (0, import_i18n.__)("Secondary", "nextora"), slug: "secondary", color: "var(--wp--preset--color--paragraph)" },
    { name: (0, import_i18n.__)("Accent", "nextora"), slug: "accent", color: "var(--wp--preset--color--accent)" }
  ];
  ...
  function ColorField({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-advanced-container__color-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "components-base-control__label", style: { marginBottom: "0.5rem" }, children: label }),
      ...
      help ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "components-base-control__help", children: help }) : null
    ] });
  }
  function Edit({ attributes, setAttributes }) {
    ...
    const resolvedBackgroundImageUrl = (0, import_data.useSelect)(
      (select) => {
    ...
    const blockProps = (0, import_block_editor.useBlockProps)({
      ...
      style: {
        ...
        backgroundColor: backgroundType === "color" ? resolveColor(backgroundColor) || void 0 : void 0,
        ...showOverlay ? {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.PanelBody, { title: (0, import_i18n.__)("Layout", "nextora"), initialOpen: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Background", "nextora"), initialOpen: false, children: [
          ...
          backgroundType === "color" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ColorField,
            {
              label: (0, import_i18n.__)("Background color", "nextora"),
              value: backgroundColor,
              colors: colorPalette,
              onChange: (value) => setAttributes({ backgroundColor: value })
            }
          ) : null,
          backgroundType === "image" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_block_editor.MediaUploadCheck, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_block_editor.MediaUpload,
            {
              ...
              render: ({ open }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.Button, { variant: "primary", onClick: open, children: backgroundImageUrl ? (0, import_i18n.__)("Replace background image", "nextora") : (0, import_i18n.__)("Select background image", "nextora") }),
                backgroundImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          backgroundType === "video" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_block_editor.MediaUploadCheck, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_block_editor.MediaUpload,
            {
              ...
              allowedTypes: ["video"],
              render: ({ open }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.Button, { variant: "primary", onClick: open, children: backgroundVideoUrl ? (0, import_i18n.__)("Replace background video", "nextora") : (0, import_i18n.__)("Select background video", "nextora") }),
                backgroundVideoUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_components.Button,
                  {
                    variant: "secondary",
                    isDestructive: true,
          ...
          backgroundType === "image" || backgroundType === "video" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ColorField,
              {
                label: (0, import_i18n.__)("Overlay color", "nextora"),
                value: overlayColor,
                colors: colorPalette,
                onChange: (value) => setAttributes({ overlayColor: value }),
                help: (0, import_i18n.__)("Empty = theme contrast color.", "nextora")
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Animation", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              ...
              help: (0, import_i18n.__)("Fade or move content in when it enters the viewport. Disabled automatically when the visitor prefers reduced motion.", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Enable parallax", "nextora"),
              checked: enableParallax,
              help: (0, import_i18n.__)("Move the background independently as the section scrolls using a smooth GSAP-driven effect. Disabled automatically when the visitor prefers reduced motion.", "nextora"),
              onChange: (value) => setAttributes({ enableParallax: value })
            }
          ),
          enableParallax ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n.__)("Parallax speed", "nextora"),
              value: parallaxSpeed,
              min: 0,
              max: 1,
              step: 0.05,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { ...blockProps, children: [
        hasImage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-advanced-container__bg", style: { backgroundImage: `url(${resolvedBackgroundImageUrl})` } }) : null,
        hasVideo ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-advanced-container__bg nextora-advanced-container__bg--video", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", { autoPlay: true, muted: true, loop: true, playsInline: true, src: backgroundVideoUrl }) }) : null,
        showOverlay ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            className: "nextora-advanced-container__overlay",
            style: {
              backgroundColor: resolvedOverlayColor || void 0,
              opacity: overlayOpacity
            }
          }
        ) : null,
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-advanced-container__inner", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_block_editor.InnerBlocks, { template: [["core/group", {}, []]] }) })
      ] })
    ] });
  }
