...
$background_color = nextora_ac_resolve_color( isset( $attributes['backgroundColor'] ) ? (string) $attributes['backgroundColor'] : '' );
...
<section <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped?>>
	<?php if ( $use_image ) : ?>
		<div class="nextora-advanced-container__bg" aria-hidden="true" style="background-image:url('<?php echo esc_url( $background_image_url ); ?>')"></div>
	...
	<?php if ( $use_overlay ) : ?>
		<div
			class="nextora-advanced-container__overlay"
			aria-hidden="true"
