...
(() => {
  ...
  // blocks/contact-form/index.tsx
  var import_blocks = __toESM(require_blocks(), 1);

  // blocks/contact-form/edit.tsx
  var import_i18n2 = __toESM(require_i18n(), 1);
  var import_block_editor = __toESM(require_block_editor(), 1);
  var import_components = __toESM(require_components(), 1);

  // blocks/contact-form/color-utils.ts
  ...
  function FieldLabel({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "nextora-contact-form__label", children: [
      ...
      required ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nextora-contact-form__required", "aria-hidden": "true", children: "*" }) : null
    ] });
  }
  function InputPlaceholderPreview({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-contact-form__input nextora-contact-form__input-preview", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_block_editor.RichText,
      {
        tagName: "span",
  ...
  function ContactFormEdit({ attributes, setAttributes }) {
    ...
    if (bg) {
      styleVars["--nextora-contact-form-bg"] = bg;
    }
    if (btnBg) {
      styleVars["--nextora-contact-form-btn-bg"] = btnBg;
    }
    if (btnText) {
      styleVars["--nextora-contact-form-btn-text"] = btnText;
    }
    const blockProps = (0, import_block_editor.useBlockProps)({
      className: "nextora-contact-form",
      style: Object.keys(styleVars).length > 0 ? styleVars : void 0
    });
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Content", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Show heading", "nextora"),
              checked: showHeading !== false,
              onChange: (value) => setAttributes({ showHeading: value })
            }
          ),
          showHeading !== false ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Heading level", "nextora"),
              value: String(level),
              options: HEADING_LEVELS,
              onChange: (value) => setAttributes({ headingLevel: parseInt(value ?? "4", 10) || 4 })
            }
          ) : null,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Show description", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Show phone field", "nextora"),
              checked: showPhone,
              onChange: (value) => setAttributes({ enablePhoneField: value })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Rich text message", "nextora"),
              ...
              onChange: (value) => setAttributes({ enableRichTextMessage: value })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Email", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("Admin email", "nextora"),
              help: (0, import_i18n2.__)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("Admin email subject", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("User email subject", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("Success message", "nextora"),
            ...
            colorSettings: [
              {
                ...
                onChange: (value) => setAttributes({ sectionBackgroundColor: normalizeColorForStorage(value, palette) }),
                label: (0, import_i18n2.__)("Section background", "nextora")
              },
              {
                value: colorValueForPicker(buttonBackgroundColor, palette),
                onChange: (value) => setAttributes({ buttonBackgroundColor: normalizeColorForStorage(value, palette) }),
                label: (0, import_i18n2.__)("Button background", "nextora")
              },
              {
                value: colorValueForPicker(buttonTextColor, palette),
                onChange: (value) => setAttributes({ buttonTextColor: normalizeColorForStorage(value, palette) }),
                label: (0, import_i18n2.__)("Button text", "nextora")
              }
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Security", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Google reCAPTCHA v3", "nextora"),
              help: (0, import_i18n2.__)(
          ...
          enableRecaptcha ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.TextControl,
              {
                label: (0, import_i18n2.__)("reCAPTCHA Site Key", "nextora"),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.TextControl,
              {
                label: (0, import_i18n2.__)("reCAPTCHA Secret Key", "nextora"),
                type: "password",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ...blockProps, children: [
        showHeading !== false ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_block_editor.RichText,
          {
            ...
            placeholder: (0, import_i18n2.__)("Get In Touch", "nextora"),
            allowedFormats: []
          }
        ) : null,
        showDescription !== false ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_block_editor.RichText,
          {
            tagName: "p",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-form nextora-contact-form__fields", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              className: showPhone ? "nextora-contact-form__row nextora-contact-form__row--two-col" : "nextora-contact-form__row",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-contact-form__field", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    FieldLabel,
                    {
                      value: fullNameLabel,
                      placeholder: (0, import_i18n2.__)("Full Name", "nextora"),
                      required: true,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    InputPlaceholderPreview,
                    {
                      ...
                      placeholder: (0, import_i18n2.__)("Enter your full name", "nextora"),
                      onChange: (value) => setAttributes({ fullNamePlaceholder: value })
                    }
                  )
                ] }),
                showPhone ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-contact-form__field", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    FieldLabel,
                    {
                      value: phoneLabel,
                      placeholder: (0, import_i18n2.__)("Phone Number", "nextora"),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    InputPlaceholderPreview,
                    {
                      ...
                      placeholder: (0, import_i18n2.__)("Enter your phone number", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-contact-form__field", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ...
              {
                value: emailLabel,
                placeholder: (0, import_i18n2.__)("Email", "nextora"),
                required: true,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              InputPlaceholderPreview,
              {
                ...
                placeholder: (0, import_i18n2.__)("Enter your email address", "nextora"),
                onChange: (value) => setAttributes({ emailPlaceholder: value })
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-contact-form__field nextora-contact-form__field--message", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              FieldLabel,
              {
                value: messageLabel,
                placeholder: (0, import_i18n2.__)("Message", "nextora"),
                required: true,
                onChange: (value) => setAttributes({ messageLabel: value })
              }
            ),
            enableRichTextMessage !== false ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                className: "nextora-tiptap-shell nextora-contact-form__tiptap-shell",
                "aria-hidden": "true",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-tiptap-toolbar nextora-contact-form__tiptap-toolbar-preview", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-tiptap-toolbar__group", children: ["bold", "italic", "strike", "code", "quote"].map((format) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "span",
                      {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-tiptap-toolbar__group nextora-tiptap-toolbar__group--end", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-contact-form__tiptap-host-preview", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    import_block_editor.RichText,
                    {
                      tagName: "span",
                      className: "nextora-contact-form__placeholder-text",
                      ...
                      placeholder: (0, import_i18n2.__)("Your message", "nextora"),
                      allowedFormats: []
                    }
                  ) })
                ]
              }
            ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-contact-form__textarea nextora-contact-form__textarea-preview", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_block_editor.RichText,
              {
                tagName: "span",
                className: "nextora-contact-form__placeholder-text",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-contact-form__submit nextora-contact-form__submit-preview wp-element-button", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_block_editor.RichText,
            {
              tagName: "span",
              ...
              placeholder: (0, import_i18n2.__)("Send Message", "nextora"),
              allowedFormats: []
            }
          ) })
        ] })
  ...
  var block_default = {
    ...
    attributes: {
      ...
      subheading: {
        type: "string",
        default: "We'd love to hear from you! If you have any questions"
      },
      buttonLabel: {
        type: "string",
