...
(() => {
  ...
  function Edit({ attributes, setAttributes }) {
    ...
    const lookupPalette = (0, import_element2.useMemo)(
    ...
    const categoryOptions = (0, import_element2.useMemo)(() => {
      const base = [
        { label: (0, import_i18n2.__)("All Categories", "nextora"), value: "" }
      ];
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Query Settings", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Number of Events", "nextora"),
              value: postsPerPage,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n2.__)("Event Category", "nextora"),
              value: category,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Timeframe", "nextora"),
              value: timeframe,
              options: [
                { label: (0, import_i18n2.__)("Upcoming Events", "nextora"), value: "upcoming" },
                { label: (0, import_i18n2.__)("Past Events", "nextora"), value: "past" },
                { label: (0, import_i18n2.__)("All Events", "nextora"), value: "all" }
              ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              ...
              value: orderBy,
              options: [
                { label: (0, import_i18n2.__)("Event Start Date", "nextora"), value: "event_date" },
                { label: (0, import_i18n2.__)("Publish Date", "nextora"), value: "date" },
                { label: (0, import_i18n2.__)("Event Title", "nextora"), value: "title" },
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              ...
              value: order,
              options: [
                { label: (0, import_i18n2.__)("Ascending (ASC)", "nextora"), value: "asc" },
                { label: (0, import_i18n2.__)("Descending (DESC)", "nextora"), value: "desc" }
              ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n2.__)("Exclude Event IDs", "nextora"),
              value: excludeIds,
              help: (0, import_i18n2.__)("Comma-separated event IDs to exclude (e.g. 102, 105).", "nextora"),
              onChange: (val) => setAttributes({ excludeIds: val })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Layout & Template", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              ...
              value: template,
              options: [
                { label: (0, import_i18n2.__)("Default (List)", "nextora"), value: "default" },
                { label: (0, import_i18n2.__)("Template 1 (Card Slider)", "nextora"), value: "template1" },
                { label: (0, import_i18n2.__)("Template 2 (Horizontal Card Slider)", "nextora"), value: "template2" },
                { label: (0, import_i18n2.__)("Template 3 (Editorial Alternating)", "nextora"), value: "template3" }
              ],
              onChange: (val) => setAttributes({ template: val })
            }
          ),
          template === "template3" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Alternating Layout", "nextora"),
              help: (0, import_i18n2.__)("Alternates the direction of odd/even items.", "nextora"),
              checked: Boolean(template3Alternating),
              onChange: (val) => setAttributes({ template3Alternating: val })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Register Button", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Show Register Button", "nextora"),
              checked: showRegisterButton,
              onChange: (val) => setAttributes({ showRegisterButton: val })
            }
          ),
          showRegisterButton && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("Default Button Text", "nextora"),
              value: registerButtonText,
              onChange: (val) => setAttributes({ registerButtonText: val })
            }
          )
        ] }),
        isSliderTemplate && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Slider Settings", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Space Between Slides (px)", "nextora"),
              value: spaceBetween,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            title: (0, import_i18n2.__)("Color Settings", "nextora"),
            colorSettings: [
              colorProps("cardBackgroundColor", (0, import_i18n2.__)("Card background", "nextora")),
              colorProps("cardBorderColor", (0, import_i18n2.__)("Card border", "nextora")),
              colorProps("dateBackgroundColor", (0, import_i18n2.__)("Date badge background", "nextora")),
              colorProps("dateDayColor", (0, import_i18n2.__)("Date day text", "nextora")),
              colorProps("dateAccentColor", (0, import_i18n2.__)("Date month text", "nextora")),
              colorProps("titleColor", (0, import_i18n2.__)("Event title", "nextora")),
              colorProps("metaColor", (0, import_i18n2.__)("Details meta text", "nextora")),
              colorProps("metaIconColor", (0, import_i18n2.__)("Details icon color", "nextora")),
              colorProps("registerBackgroundColor", (0, import_i18n2.__)("Register button background", "nextora")),
              colorProps("registerTextColor", (0, import_i18n2.__)("Register button text", "nextora")),
              colorProps("registerBorderColor", (0, import_i18n2.__)("Register button border", "nextora")),
              colorProps("registerHoverBackgroundColor", (0, import_i18n2.__)("Register button hover background", "nextora")),
              colorProps("registerHoverTextColor", (0, import_i18n2.__)("Register button hover text", "nextora")),
              colorProps("registerHoverBorderColor", (0, import_i18n2.__)("Register button hover border", "nextora")),
              ...isSliderTemplate ? [
                colorProps("paginationColor", (0, import_i18n2.__)("Pagination dot", "nextora")),
                colorProps("paginationActiveColor", (0, import_i18n2.__)("Pagination dot active", "nextora"))
              ] : []
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.PanelBody, { title: (0, import_i18n2.__)("Animation", "nextora"), initialOpen: false, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_components.ToggleControl,
          {
            label: (0, import_i18n2.__)("Enable scroll reveal animation", "nextora"),
