...
(() => {
  ...
  // blocks/google-maps/index.tsx
  var import_blocks = __toESM(require_blocks(), 1);

  // blocks/google-maps/edit.tsx
  var import_i18n = __toESM(require_i18n(), 1);
  var import_block_editor = __toESM(require_block_editor(), 1);
  var import_components = __toESM(require_components(), 1);

  // blocks/google-maps/editor-api-preview.tsx
  ...
  function loadGoogleMapsScript(apiKey) {
    return new Promise((resolve, reject) => {
      ...
      const existing = document.getElementById(handle);
      if (existing) {
  ...
  function ApiMapPreview({
    ...
    const canvasRef = (0, import_element.useRef)(null);
    (0, import_element.useEffect)(() => {
      ...
      let cancelled = false;
      loadGoogleMapsScript(trimmedKey).then(() => {
        ...
        markers.forEach((markerData) => {
          const marker = new googleMaps.Marker({
            ...
            icon: markerData.iconUrl ? markerData.iconUrl : void 0
          });
  ...
  // blocks/google-maps/iframe-src.ts
  function buildIframeSrc(address, lat, lng, zoom, apiKey, showControls) {
    ...
    if (apiKey.trim() !== "") {
      ...
      if (!showControls) {
        params2.set("zoomControl", "false");
        params2.set("streetViewControl", "false");
        params2.set("maptypeControl", "false");
        params2.set("fullscreenControl", "false");
      }
      return `https://www.google.com/maps/embed/v1/place?${params2.toString()}`;
    }
  ...
  function validateStyleJson(value) {
    ...
    try {
      ...
      if (!Array.isArray(parsed)) {
        return (0, import_i18n.__)("Custom style JSON must be an array.", "nextora");
      }
      return null;
    } catch {
      return (0, import_i18n.__)("Custom style JSON is invalid.", "nextora");
    }
  }
  function GoogleMapsEdit({ attributes, setAttributes }) {
    const {
      mapMode = "iframe",
      address = "",
      lat = 21.0285,
    ...
    const locationLabel = address.trim() !== "" ? address.trim() : `${lat}, ${lng}`;
    const mapPreviewTitle = `${(0, import_i18n.__)("Map showing", "nextora")} ${locationLabel}`;
    const iframeSrc = isIframeMode ? buildIframeSrc(address, lat, lng, zoom, trimmedApiKey, showControls) : "";
    ...
    const updateMarker = (id, field, value) => {
      setAttributes({
        markers: markers.map(
          (marker) => marker.id === id ? { ...marker, [field]: value } : marker
        )
      });
    };
    const addMarker = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Settings", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.RadioControl,
            {
              label: (0, import_i18n.__)("Map mode", "nextora"),
              selected: mapMode,
              options: [
                {
                  label: (0, import_i18n.__)("Iframe embed", "nextora"),
                  value: "iframe"
                },
                {
                  label: (0, import_i18n.__)("JavaScript API", "nextora"),
                  value: "api"
                }
              ],
              onChange: (value) => setAttributes({ mapMode: value ?? "iframe" }),
              help: isIframeMode ? (0, import_i18n.__)(
          ...
          isApiMode && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.TextControl,
              {
                label: (0, import_i18n.__)("Google Maps API key", "nextora"),
                value: apiKey,
            ...
            trimmedApiKey === "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components.Notice, { status: "warning", isDismissible: false, children: (0, import_i18n.__)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Address / location", "nextora"),
              value: address,
              ...
              placeholder: (0, import_i18n.__)("123 Main Street, Hanoi", "nextora")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.__experimentalNumberControl,
            {
              label: (0, import_i18n.__)("Latitude", "nextora"),
              value: lat,
              onChange: (value) => setAttributes({ lat: parseFloat(String(value ?? "0")) || 0 }),
              help: (0, import_i18n.__)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.__experimentalNumberControl,
            {
              label: (0, import_i18n.__)("Longitude", "nextora"),
              value: lng,
              onChange: (value) => setAttributes({ lng: parseFloat(String(value ?? "0")) || 0 }),
              help: (0, import_i18n.__)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            ...
            {
              label: (0, import_i18n.__)("Zoom level", "nextora"),
              value: zoom,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.__experimentalNumberControl,
            {
              label: (0, import_i18n.__)("Map height (px)", "nextora"),
              value: height,
              onChange: (value) => setAttributes({ mapHeight: parseInt(String(value ?? "450"), 10) || 450 }),
              min: 200,
              max: 1200,
              help: (0, import_i18n.__)("Height of the map container in the editor and on the front end.", "nextora")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.__experimentalNumberControl,
            {
              label: (0, import_i18n.__)("Border radius (px)", "nextora"),
              value: radiusPx,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            ...
            {
              label: (0, import_i18n.__)("Show map controls", "nextora"),
        ...
        isApiMode && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Markers", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "nextora-google-maps__inspector-markers", children: markers.map((marker) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nextora-google-maps__inspector-marker", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.TextControl,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.__experimentalNumberControl,
              {
                label: (0, import_i18n.__)("Latitude", "nextora"),
                value: marker.lat,
                onChange: (value) => updateMarker(marker.id, "lat", parseFloat(String(value ?? "0")) || 0)
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.__experimentalNumberControl,
              {
                label: (0, import_i18n.__)("Longitude", "nextora"),
                value: marker.lng,
                onChange: (value) => updateMarker(marker.id, "lng", parseFloat(String(value ?? "0")) || 0)
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.TextareaControl,
              {
                label: (0, import_i18n.__)("Info popup HTML", "nextora"),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.TextControl,
              {
                label: (0, import_i18n.__)("Custom icon URL", "nextora"),
                value: marker.iconUrl,
                onChange: (value) => updateMarker(marker.id, "iconUrl", value ?? ""),
                help: (0, import_i18n.__)("Leave empty to use the default pin.", "nextora")
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "nextora-google-maps__inspector-marker-actions", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              import_components.Button,
              {
                ...
                children: (0, import_i18n.__)("Remove marker", "nextora")
              }
            ) })
          ] }, marker.id)) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components.PanelRow, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components.Button, { variant: "primary", onClick: addMarker, children: (0, import_i18n.__)("Add marker", "nextora") }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.TextareaControl,
            {
              label: (0, import_i18n.__)("Custom style JSON", "nextora"),
              value: mapStyleJson,
          ...
          styleError && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components.Notice, { status: "error", isDismissible: false, className: "nextora-google-maps__style-error", children: styleError }),
          markers.length >= 2 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show directions", "nextora"),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components.PanelBody, { title: (0, import_i18n.__)("Animation", "nextora"), initialOpen: false, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_components.ToggleControl,
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { ...blockProps, children: [
        isIframeMode && iframeSrc !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "iframe",
          {
        ...
        isApiMode && trimmedApiKey !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ApiMapPreview,
          {
        ...
        isApiMode && trimmedApiKey === "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "nextora-google-maps__editor-empty", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dashicons dashicons-location-alt", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: (0, import_i18n.__)(
            "Enter a Google Maps API key in Settings to preview the interactive map.",
            "nextora"
          ) })
        ] }),
        (isIframeMode && iframeSrc !== "" || isApiMode && trimmedApiKey !== "") && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "div",
          {
