...
(() => {
  ...
  // blocks/plugin-notice/index.tsx
  var import_blocks = __toESM(require_blocks(), 1);

  // blocks/plugin-notice/edit.tsx
  var import_i18n = __toESM(require_i18n(), 1);
  var import_block_editor = __toESM(require_block_editor(), 1);
  var import_components = __toESM(require_components(), 1);
  var import_element = __toESM(require_element(), 1);

  // blocks/plugin-notice/types.ts
  var PLUGIN_PRESETS = [
    {
      id: "mailchimp-for-wp",
  ...
  var DEFAULT_MESSAGE = "A compatible plugin is required to use this feature. Choose a recommended plugin below or connect another supported option.";
  var DEFAULT_PLUGINS_LABEL = "Recommended plugins:";
  var DEFAULT_PLUGINS = PLUGIN_PRESETS.map((preset) => ({
    id: preset.id,
    name: preset.name,
    url: preset.url
  }));
  ...
  function createPluginFromPreset(preset) {
    return { id: preset.id, name: preset.name, url: preset.url };
  }
  function resolvePlugins(attributes) {
  ...
  function hasContent(plugin) {
    return plugin.name.trim() !== "" || plugin.url.trim() !== "";
  }
  function PluginNoticeEdit({
    attributes,
    setAttributes
  }) {
    const { message, pluginsLabel, enableScrollAnimation = true } = attributes;
    const label = pluginsLabel?.trim() || DEFAULT_PLUGINS_LABEL;
    const plugins = (0, import_element.useMemo)(() => resolvePlugins(attributes), [attributes]);
    ...
    const patchPlugin = (index, patch) => {
      setAttributes({
        plugins: plugins.map(
          (plugin, i) => i === index ? { ...plugin, ...patch } : plugin
        )
      });
    };
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Settings", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n.__)("Message", "nextora"),
              value: message,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.Button,
            {
              ...
              children: (0, import_i18n.__)("Reset to default", "nextora")
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Plugins", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Plugins line label", "nextora"),
              value: pluginsLabel,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "components-base-control__help nextora-plugin-notice__panel-help", children: (0, import_i18n.__)(
            "Add a plugin name and link for each entry, or use a theme preset below.",
            "nextora"
          ) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-plugin-notice__inspector-plugins", children: plugins.map((plugin, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              className: "nextora-plugin-notice__inspector-plugin",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "nextora-plugin-notice__inspector-plugin-label", children: [
                  (0, import_i18n.__)("Plugin", "nextora"),
                  " ",
                  index + 1
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_components.TextControl,
                  {
                    label: (0, import_i18n.__)("Link", "nextora"),
                    value: plugin.url,
                    placeholder: "https://",
            ...
            plugin.id || `plugin-${index}`
          )) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.PanelRow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.Button,
            {
              variant: "primary",
              onClick: () => setAttributes({ plugins: [...plugins, createEmptyPlugin()] }),
              children: (0, import_i18n.__)("Add plugin", "nextora")
            }
          ) }),
          availablePresets.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-plugin-notice__preset-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "components-base-control__label", children: (0, import_i18n.__)("Theme presets", "nextora") }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-plugin-notice__preset-buttons", children: availablePresets.map((preset) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.Button,
              {
                variant: "secondary",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...blockProps, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-plugin-notice__inner", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        displayPlugins.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "nextora-plugin-notice__plugins", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nextora-plugin-notice__plugins-label", children: label }),
          " ",
          displayPlugins.map((plugin, index) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
              plugin.url.trim() ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "a",
                {
              ...
              ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nextora-plugin-notice__plugin-name", children: name }),
              separator
            ] }, plugin.id);
          })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "nextora-plugin-notice__empty", children: (0, import_i18n.__)("Add at least one plugin in the sidebar.", "nextora") })
      ] }) })
    ] });
  }

  // blocks/plugin-notice/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "nextora/plugin-notice",
    title: "Plugin Notice",
    category: "design",
    description: "Dotted-border notice with a message and links to supported plugins.",
    keywords: ["plugin", "notice", "announcement", "nextora"],
    textdomain: "nextora",
    icon: "admin-plugins",
    supports: {
      html: false,
    ...
    attributes: {
      message: {
        type: "string",
        default: "A compatible plugin is required to use this feature. Choose a recommended plugin below or connect another supported option."
      },
      pluginsLabel: {
        type: "string",
