...
(() => {
  ...
  // blocks/spotlight-search/index.tsx
  var import_blocks = __toESM(require_blocks(), 1);

  // blocks/spotlight-search/edit.tsx
  var import_i18n = __toESM(require_i18n(), 1);
  var import_block_editor = __toESM(require_block_editor(), 1);
  var import_components = __toESM(require_components(), 1);
  var import_server_side_render = __toESM(require_server_side_render(), 1);
  var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
  function SpotlightSearchEdit({ attributes, setAttributes }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Spotlight search", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Modal ID (optional)", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Dialog title", "nextora"),
              value: attributes.titleText,
              onChange: (titleText) => setAttributes({ titleText }),
              placeholder: (0, import_i18n.__)("Leave empty for default", "nextora")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show subtitle", "nextora"),
              checked: attributes.showSubtitle,
              onChange: (showSubtitle) => setAttributes({ showSubtitle })
            }
          ),
          attributes.showSubtitle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Subtitle", "nextora"),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            enableAlpha: true,
            title: (0, import_i18n.__)("Icon", "nextora"),
            colorSettings: [
              {
                value: attributes.iconColor,
                onChange: (iconColor) => setAttributes({ iconColor: iconColor ?? "" }),
                label: (0, import_i18n.__)("Search icon color", "nextora")
              }
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Labels", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Open button (screen reader)", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Close button (screen reader)", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n.__)("Search field label", "nextora"),
  ...
  // blocks/spotlight-search/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "nextora/spotlight-search",
    title: "Spotlight search",
    category: "theme",
    description: "Header search control that opens a modal with live REST search (same UI as the theme spotlight).",
    keywords: ["search", "spotlight", "modal", "nextora"],
    textdomain: "nextora",
    supports: {
      html: false,
      align: false,
