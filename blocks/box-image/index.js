        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Layout", "nextora"), opened: panelStates.layout, onToggle: togglePanel("layout"), children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              ...
              onChange: (v) => {
                const tpl = v === "template1" ? "template1" : v === "template2" ? "template2" : v === "template3" ? "template3" : "default";
