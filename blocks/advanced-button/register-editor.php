...
/**
 * Editor-only assets for nextora/advanced-button block.
 *
 * @package Nextora
 */
 ...
 */
function nextora_advanced_button_block_editor_assets(): void {
	$handle = 'nextora-advanced-button-editor-script';
...
add_action( 'enqueue_block_editor_assets', 'nextora_advanced_button_block_editor_assets', 100 );
