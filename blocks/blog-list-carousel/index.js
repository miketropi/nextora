...
(() => {
  ...
  var titleFontSizeOptions = [
    ...
    { label: (0, import_i18n2.__)("2XL", "nextora"), value: "xx-large" }
  ];
  ...
  function BlogListCarouselEdit({ attributes, setAttributes }) {
    ...
    const titleFontSizeCSS = normalizedTitleSize && [
      "small",
      "base",
      "medium",
      "medium-plus",
      ...
      "x-large",
      "xx-large"
    ].includes(normalizedTitleSize) ? `var(--wp--preset--font-size--${normalizedTitleSize})` : void 0;
    const normalizedExcerptSize = excerptFontSize ? fontSizeAliasMap[excerptFontSize] ?? excerptFontSize : "";
    const excerptFontSizeCSS = normalizedExcerptSize && [
      "small",
      "base",
      "medium",
      "medium-plus",
      ...
      "x-large",
      "xx-large"
    ].includes(normalizedExcerptSize) ? `var(--wp--preset--font-size--${normalizedExcerptSize})` : void 0;
    ...
    const blockProps = (0, import_block_editor.useBlockProps)({
      ...
      style: {
        ...
        "--nextora-blc-edge-fade-color": edgeFadeColor || void 0
      }
    });
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Card Content", "nextora"), initialOpen: false, children: [
          ...
          showExcerpt && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.SelectControl,
              {
                label: (0, import_i18n2.__)("Excerpt font size", "nextora"),
                value: excerptFontSize,
                options: titleFontSizeOptions,
                onChange: (v) => setAttributes({ excerptFontSize: v }),
                help: (0, import_i18n2.__)("Overrides the default card excerpt size.", "nextora")
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.RangeControl,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: layoutMode === "grid" ? (0, import_i18n2.__)("Carousel (tablet & mobile)", "nextora") : (0, import_i18n2.__)("Carousel Settings", "nextora"), initialOpen: false, children: [
          layoutMode === "carousel" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              ...
              value: slidesPerView,
              onChange: (v) => setAttributes({
                slidesPerView: v !== void 0 ? Math.round(v * 100) / 100 : 3
              }),
              min: 1,
              max: 6,
              step: 0.1
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              ...
              onChange: (v) => setAttributes({
                slidesPerViewTablet: v !== void 0 ? Math.round(v * 100) / 100 : 2
              }),
              min: 1,
              max: 4,
              step: 0.1
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              ...
              onChange: (v) => setAttributes({
                slidesPerViewMobile: v !== void 0 ? Math.round(v * 100) / 100 : 1.15
              }),
              min: 1,
              max: 3,
              step: 0.1
          ...
          import_block_editor.PanelColorSettings,
          {
            ...
            colorSettings: [
              ...
              ...cardTemplate === "template-1" ? [
                {
                  ...
                  onChange: (v) => setThemeColor("cardMetaIconColor", v),
                  label: (0, import_i18n2.__)("Meta icon color", "nextora")
                },
                {
              ...
              ] : [],
              {
                ...
                label: (0, import_i18n2.__)("Edge fade overlay", "nextora")
              }
            ]
          }
        ),
  ...
  var block_default = {
    ...
    title: "Blog Posts",
    category: "nextora",
    description: "Display blog posts in a carousel, grid, or list layout with customizable query and card settings.",
    keywords: [
      "blog",
      "posts",
      "carousel",
