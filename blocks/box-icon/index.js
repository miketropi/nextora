        ...
        return [
          {
            value: colorValueForPicker(iconColor, colorPalette, lookupPalette),
            onChange: (v) => setThemeColor("iconColor", v),
            label: (0, import_i18n5.__)("Dot border & time color", "nextora")
          },
          {
              ...
              CardTag,
              {
                ...
                children: [
                  ...
                  cardTemplate === "highlights" ? (() => {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("time", { className: "nextora-box-icon__timeline-time", children: item.number || (0, import_i18n5.__)("T + 0H", "nextora") }),
