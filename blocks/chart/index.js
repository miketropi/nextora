...
(() => {
  ...
  function Edit({ attributes, setAttributes }) {
    ...
    const [valueInputs, setValueInputs] = (0, import_element.useState)({});
    const maxValue = Math.max(...dataPoints.map((d) => d.value), 1);
    const hasData = dataPoints.length > 0;
    const chartTypeLabel = chartType === "bar" ? (0, import_i18n.__)("Bar Chart", "nextora") : chartType === "doughnut" ? (0, import_i18n.__)("Doughnut Chart", "nextora") : (0, import_i18n.__)("Line Chart", "nextora");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Data", "nextora"), initialOpen: true, children: [
          dataPoints.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "#888", fontStyle: "italic", marginBottom: "8px" }, children: (0, import_i18n.__)("No data points yet. Add one below.", "nextora") }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  ...
                  {
                    label: index === 0 ? (0, import_i18n.__)("Label", "nextora") : void 0,
                    value: dp.label,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: "80px" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_components.TextControl,
                  {
                    label: index === 0 ? (0, import_i18n.__)("Value", "nextora") : void 0,
                    type: "text",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  ...
                  {
                    icon: "trash",
                    label: (0, import_i18n.__)("Remove data point", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.Button,
            {
              ...
              __next40pxDefaultSize: true,
              children: (0, import_i18n.__)("Add data point", "nextora")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: "16px" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n.__)("Chart type", "nextora"),
              value: chartType,
              options: [
                { label: (0, import_i18n.__)("Line", "nextora"), value: "line" },
                { label: (0, import_i18n.__)("Bar", "nextora"), value: "bar" },
                { label: (0, import_i18n.__)("Doughnut", "nextora"), value: "doughnut" }
              ],
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Display", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show data labels", "nextora"),
              help: (0, import_i18n.__)("Display values on chart elements", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show legend", "nextora"),
              checked: showLegend,
          ...
          showLegend && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n.__)("Legend position", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show tooltip", "nextora"),
              checked: showTooltip,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n.__)("Chart height", "nextora"),
              value: chartHeight,
            ...
            colorSettings: [
              {
                ...
                label: (0, import_i18n.__)("Line / Bar color", "nextora")
              },
              {
                value: fillColor ?? "",
                onChange: (v) => setAttributes({ fillColor: v }),
                label: (0, import_i18n.__)("Fill color", "nextora")
              },
              {
                value: textColor ?? "",
                onChange: (v) => setAttributes({ textColor: v }),
                label: (0, import_i18n.__)("Text & label color", "nextora")
              },
              {
                value: gridColor ?? "",
                onChange: (v) => setAttributes({ gridColor: v }),
                label: (0, import_i18n.__)("Grid line color", "nextora")
              }
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n.__)("Grid & Axis", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show X grid lines", "nextora"),
              checked: showXGrid,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show Y grid lines", "nextora"),
              checked: showYGrid,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show X-axis labels", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n.__)("Show Y-axis labels", "nextora"),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...blockProps, children: !hasData ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-chart-editor__placeholder", children: (0, import_i18n.__)("Add data points in the sidebar to preview the chart.", "nextora") }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-chart-editor__preview", children: [
