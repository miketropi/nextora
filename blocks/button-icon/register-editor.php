...
/**
 * Editor-only assets for nextora/button-icon block.
 *
 * @package Nextora
 */
 ...
 */
function nextora_button_icon_block_editor_assets(): void {
	$handle = 'nextora-button-icon-editor-script';
...
add_action( 'enqueue_block_editor_assets', 'nextora_button_icon_block_editor_assets', 100 );
