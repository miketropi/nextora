...
(() => {
  ...
  var block_default = {
    ...
    attributes: {
      ...
      eyebrowText: {
        type: "string",
        default: "Protecting People & Planet"
      },
      headingText: {
        type: "string",
        default: "Join Save the World in Creating a Future That's Worth Inheriting"
      },
      descriptionText: {
        type: "string",
        default: "Save the World restores forests, protects clean water, and helps communities face climate change together."
      },
      headingLevel: {
        type: "number",
        default: 2
