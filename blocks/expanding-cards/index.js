...
(() => {
  ...
  // blocks/expanding-cards/index.tsx
  var import_blocks = __toESM(require_blocks(), 1);

  // blocks/expanding-cards/edit.tsx
  ...
  // blocks/expanding-cards/color-utils.ts
  ...
  function getGutenbergFontSizeClass(size) {
    if (!size) return "";
  ...
  var FONT_SIZE_OPTIONS = [
    ...
    { label: (0, import_i18n2.__)("Small", "nextora"), value: "small" },
    { label: (0, import_i18n2.__)("Base", "nextora"), value: "base" },
    { label: (0, import_i18n2.__)("Medium", "nextora"), value: "medium" },
    { label: (0, import_i18n2.__)("Medium Plus", "nextora"), value: "medium-plus" },
    { label: (0, import_i18n2.__)("Large", "nextora"), value: "large" },
    { label: (0, import_i18n2.__)("Extra Large", "nextora"), value: "x-large" },
    { label: (0, import_i18n2.__)("Extra Extra Large", "nextora"), value: "xx-large" }
  ];
  var ICONS = {
  ...
  function ItemModal({ item, onSave, onClose }) {
    ...
    const onSelectImage = (0, import_element2.useCallback)((media) => {
      setEdit((prev) => ({
        ...prev,
        imageId: media.id ?? 0,
        imageUrl: media.url ?? "",
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      {
        title: (0, import_i18n2.__)("Edit card", "nextora"),
        onRequestClose: onClose,
        className: "nextora-expanding-cards-modal",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-expanding-cards-modal__content", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-expanding-cards-modal__image-col", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_block_editor.MediaUploadCheck, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_block_editor.MediaUpload,
                {
                  ...
                  allowedTypes: ["image"],
                  value: edit.imageId > 0 ? edit.imageId : void 0,
                  render: ({ open }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-expanding-cards-modal__media", children: [
                    edit.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "img",
                      {
                        src: edit.imageUrl,
                        alt: "",
                      ...
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: (0, import_i18n2.__)("Choose image", "nextora") })
                      }
                    ),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-expanding-cards-modal__media-actions", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.Button, { variant: "secondary", onClick: open, size: "small", children: edit.imageUrl ? (0, import_i18n2.__)("Replace image", "nextora") : (0, import_i18n2.__)("Choose image", "nextora") }),
                      edit.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ...
              edit.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_components.TextControl,
                {
                  ...
                  value: edit.imageAlt,
                  onChange: (imageAlt) => setEdit((prev) => ({ ...prev, imageAlt: imageAlt ?? "" }))
                }
              ) : null
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-expanding-cards-modal__fields-col", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_components.TextControl,
                {
                  label: (0, import_i18n2.__)("Heading", "nextora"),
                  value: edit.heading,
                  onChange: (heading) => setEdit((prev) => ({ ...prev, heading: heading ?? "" }))
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_components.TextControl,
                {
                  ...
                  onChange: (buttonText) => setEdit((prev) => ({
                    ...prev,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_components.TextControl,
                {
                  label: (0, import_i18n2.__)("Button URL", "nextora"),
                  value: edit.buttonUrl,
                  onChange: (buttonUrl) => setEdit((prev) => ({
                    ...prev,
                    buttonUrl: buttonUrl ?? "#"
                  })),
                  placeholder: "#"
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-expanding-cards-modal__actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.Button, { variant: "primary", onClick: handleSave, children: (0, import_i18n2.__)("Save", "nextora") }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.Button, { variant: "secondary", onClick: onClose, children: (0, import_i18n2.__)("Cancel", "nextora") })
          ] })
        ]
      }
    );
  }
  function ExpandingCardsEdit({ attributes, setAttributes }) {
    ...
    const addCard = () => {
      const newItem = {
        ...EMPTY_ITEM,
        id: createItemId(),
        heading: (0, import_i18n2.__)("New card", "nextora")
      };
    ...
    const editingItem = editingItemId ? cards.find((item) => item.id === editingItemId) : void 0;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Cards", "nextora"), initialOpen: true, children: [
          cards.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "components-base-control__help", style: { marginBottom: "8px" }, children: (0, import_i18n2.__)('No cards yet. Click "Add card" to create one.', "nextora") }),
          cards.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                        "span",
                        {
                          ...
                          children: item.heading || (0, import_i18n2.sprintf)((0, import_i18n2.__)("Card %d", "nextora"), index + 1)
                        }
                      )
                    ]
                  }
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_components.Button,
                  {
                    ...
                    label: (0, import_i18n2.__)("Edit", "nextora"),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_components.Button,
                  {
                    ...
                    label: (0, import_i18n2.__)("Remove", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.Button,
            {
              ...
              children: (0, import_i18n2.__)("Add card", "nextora")
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Layout", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n2.__)("Card height (px)", "nextora"),
              value: cardHeight,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Card gap (px)", "nextora"),
              value: cardGap,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Inactive overlay opacity", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Content padding \u2014 vertical (px)", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Content padding \u2014 horizontal (px)", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Default active card", "nextora"),
              help: (0, import_i18n2.__)("Which card is expanded when the page first loads.", "nextora"),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Typography", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Heading font size", "nextora"),
              value: headingSize,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Description font size", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Button font size", "nextora"),
              value: buttonSize,
              options: FONT_SIZE_OPTIONS,
          ...
          import_block_editor.PanelColorSettings,
          {
            ...
            colorSettings: [
              ...
              },
              {
                ...
                label: (0, import_i18n2.__)("Overlay", "nextora")
              },
              {
              ...
              },
              {
                ...
                label: (0, import_i18n2.__)("Button background", "nextora")
              },
              {
                value: colorValueForPicker(buttonBorderColor, colorPalette, lookupPalette),
                onChange: (v) => setThemeColor("buttonBorderColor", v),
                label: (0, import_i18n2.__)("Button border", "nextora")
              }
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.PanelBody, { title: (0, import_i18n2.__)("Animation", "nextora"), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...blockProps, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-expanding-cards__row", children: cards.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "span",
              {
                ...
                "aria-hidden": "true",
                style: item.imageUrl ? { backgroundImage: `url(${item.imageUrl})` } : void 0
              }
            ),
            !item.imageUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nextora-expanding-cards__card-placeholder", children: (0, import_i18n2.sprintf)((0, import_i18n2.__)("Card %d", "nextora"), index + 1) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nextora-expanding-cards__card-overlay", "aria-hidden": "true" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "nextora-expanding-cards__card-content", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { className: headingClasses, style: headingColorProps.style, children: item.heading || (0, import_i18n2.sprintf)((0, import_i18n2.__)("Card %d", "nextora"), index + 1) }),
              item.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: descClasses, style: descColorProps.style, children: item.description }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: btnClasses, style: btnStyle, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InlineSvg, { name: "pawPrint", className: "nextora-expanding-cards__card-button-icon" }),
                item.buttonText || (0, import_i18n2.__)("Start adoption", "nextora")
              ] })
            ] })
          ]
        },
      ...
      editingItem && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ItemModal,
        {
          item: editingItem,
          onSave: updateCard,
  ...
  // blocks/expanding-cards/block.json
  var block_default = {
