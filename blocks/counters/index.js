...
(() => {
  ...
  function getElementTypographyProps(attrs) {
    const { color = "", fontSize = "", fontFamily = "" } = attrs;
    const classes = [];
    const style = {};
    const trimmedColor = color.trim();
    if (trimmedColor) {
      if (trimmedColor === "transparent" || trimmedColor === "rgba(0,0,0,0)" || trimmedColor === "#00000000") {
  ...
  // blocks/counters/color-utils.ts
  ...
  var textAlignOptions = [
    { label: (0, import_i18n2.__)("Center", "nextora"), value: "center" },
    { label: (0, import_i18n2.__)("Left", "nextora"), value: "left" },
    { label: (0, import_i18n2.__)("Right", "nextora"), value: "right" }
  ];
  var easingOptions = [
    { label: (0, import_i18n2.__)("Linear", "nextora"), value: "linear" },
    { label: (0, import_i18n2.__)("Ease out cubic", "nextora"), value: "easeOutCubic" },
    { label: (0, import_i18n2.__)("Ease out expo", "nextora"), value: "easeOutExpo" }
  ];
  function createId() {
  ...
  function CountersEdit({ attributes, setAttributes }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Counter items", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "nextora-counters__inspector-items", children: items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-counters__inspector-item", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-counters__inspector-item-fields", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ...
                {
                  label: (0, import_i18n2.__)("Prefix", "nextora"),
                  value: item.prefix,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_components.TextControl,
                {
                  label: (0, import_i18n2.__)("Number", "nextora"),
                  type: "number",
                  value: String(item.number),
                  onChange: (value) => updateItem(item.id, "number", Math.abs(parseFloat(value ?? "") || 0))
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_components.TextControl,
                {
                  label: (0, import_i18n2.__)("Suffix", "nextora"),
                  value: item.suffix,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.TextControl,
              {
                ...
                placeholder: (0, import_i18n2.__)("Books & Supplies Provided", "nextora")
              }
            ),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.PanelRow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_components.Button, { variant: "primary", onClick: addItem, children: (0, import_i18n2.__)("Add counter", "nextora") }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Layout", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n2.__)("Columns \u2014 small screens", "nextora"),
              value: colsMobile,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Columns \u2014 medium (400px+)", "nextora"),
              value: colsTablet,
              onChange: (value) => setAttributes({
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.RangeControl,
            {
              label: (0, import_i18n2.__)("Columns \u2014 large (960px+)", "nextora"),
              value: colsDesktop,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("Column gap", "nextora"),
              value: columnGap,
              onChange: (value) => setAttributes({ columnGap: value ?? "" }),
              help: (0, import_i18n2.__)("Leave empty to use the theme default spacing.", "nextora"),
              placeholder: "2rem"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.TextControl,
            {
              label: (0, import_i18n2.__)("Number \u2194 label gap", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n2.__)("Show dividers", "nextora"),
              checked: divider,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              label: (0, import_i18n2.__)("Text alignment", "nextora"),
              value: textAlign,
        ...
        divider && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ...
          {
            enableAlpha: true,
            title: (0, import_i18n2.__)("Divider", "nextora"),
            colorSettings: [
              {
                ...
                label: (0, import_i18n2.__)("Divider color", "nextora")
              }
            ]
          }
        ),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Typography", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Number font", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.SelectControl,
            {
              label: (0, import_i18n2.__)("Label font", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.BaseControl,
            {
              ...
              label: (0, import_i18n2.__)("Number font size", "nextora"),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            ...
            {
              className: "nextora-counters__font-size-control",
              label: (0, import_i18n2.__)("Label font size", "nextora"),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_components.PanelBody, { title: (0, import_i18n2.__)("Animation", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_components.ToggleControl,
            {
              label: (0, import_i18n2.__)("Enable count-up", "nextora"),
              help: (0, import_i18n2.__)(
          ...
          enableCountUp !== false && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.RangeControl,
              {
                label: (0, import_i18n2.__)("Duration (ms)", "nextora"),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_components.SelectControl,
              {
                label: (0, import_i18n2.__)("Easing", "nextora"),
                value: countUpEasing,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...blockProps, children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nextora-counters__item", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
          {
            className: ["nextora-counters__number", numberTypography.className].filter(Boolean).join(" "),
            style: numberTypography.style,
            "aria-label": formatDisplay(item),
            children: formatDisplay(item)
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
          {
            className: ["nextora-counters__label", labelTypography.className].filter(Boolean).join(" "),
