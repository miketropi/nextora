      ...
      if (iconSource === "theme" && iconNodes) {
        const preview = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          LucideSvgPreview,
          {
            nodes: iconNodes,
            size: iconSize,
            color: iconColor || resolvedButtonTextColor ? storedColorToCss(iconColor || resolvedButtonTextColor) : "currentColor",
            strokeWidth
          }
        );
        if (hasSurfaceStyle) {
