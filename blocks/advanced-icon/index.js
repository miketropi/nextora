...
(() => {
  ...
  function gradientValueForPicker(stored, gradients) {
    if (!stored) {
      return void 0;
    }
    for (const preset of gradients) {
  ...
  function IconEdit({
    ...
    const themeGradients = (0, import_data2.useSelect)(
      (select) => {
        try {
          const settings = select("core/block-editor").getSettings?.() ?? {};
    ...
    if (typeof blockProps.className === "string") {
      blockProps.className = blockProps.className.split(/\s+/).filter((c) => !/^has-(margin|padding)-/.test(c)).join(" ").trim();
    }
    if (blockProps.style && typeof blockProps.style === "object") {
      const spacingProps = /* @__PURE__ */ new Set(["margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft"]);
      const filtered = {};
      for (const [key, value] of Object.entries(blockProps.style)) {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_block_editor.InspectorControls, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components2.PanelBody, { title: (0, import_i18n3.__)("Animation", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            ...
            {
              label: (0, import_i18n3.__)("Enable Lucide icon animation", "nextora"),
              help: (0, import_i18n3.__)(
              ...
              onChange: (value) => setAttributes({ enableIconAnimation: value })
            }
          ),
          iconSource === "theme" && enableIconAnimation && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.SelectControl,
            {
              label: (0, import_i18n3.__)("Animation trigger", "nextora"),
              value: iconAnimationTrigger,
              options: [
                { label: (0, import_i18n3.__)("On hover and keyboard focus", "nextora"), value: "hover" },
                { label: (0, import_i18n3.__)("Once when visible", "nextora"), value: "when-visible" },
                { label: (0, import_i18n3.__)("Loop while visible (slow)", "nextora"), value: "loop" }
              ],
              onChange: (value) => setAttributes({ iconAnimationTrigger: value }),
              help: (0, import_i18n3.__)("Automatic modes are disabled when reduced motion is preferred.", "nextora")
            }
          ),
          iconSource === "theme" && enableIconAnimation && iconAnimationTrigger === "loop" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.RangeControl,
            {
              label: (0, import_i18n3.__)("Pause between loop cycles (ms)", "nextora"),
              value: iconAnimationLoopPause,
              onChange: (value) => setAttributes({ iconAnimationLoopPause: value ?? 600 }),
              min: 0,
              max: 3e3,
              step: 100,
              help: (0, import_i18n3.__)("Wait time after one animation finishes before it starts again.", "nextora")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.ToggleControl,
