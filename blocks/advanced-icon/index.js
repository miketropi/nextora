...
(() => {
  ...
  function IconEdit({
    ...
    const [pickerOpen, setPickerOpen] = (0, import_element3.useState)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_block_editor.InspectorControls, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components2.PanelBody, { title: (0, import_i18n2.__)("Settings", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.RadioControl,
            {
              label: (0, import_i18n2.__)("Source", "nextora"),
              selected: iconSource,
              options: [
                {
                  label: (0, import_i18n2.__)("Theme icon", "nextora"),
                  value: "theme"
                },
                {
                  label: (0, import_i18n2.__)("Upload custom icon", "nextora"),
                  value: "upload"
                }
              ],
          ...
          iconSource === "upload" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_block_editor.MediaUploadCheck, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_block_editor.MediaUpload,
            {
              ...
              render: ({ open }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components2.Button, { variant: "secondary", onClick: open, children: uploadedIconUrl ? (0, import_i18n2.__)("Replace icon image", "nextora") : (0, import_i18n2.__)("Upload icon image", "nextora") })
            }
          ) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components2.PanelBody, { title: (0, import_i18n2.__)("Layout", "nextora"), initialOpen: true, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.SelectControl,
            {
              label: (0, import_i18n2.__)("Theme style", "nextora"),
              value: iconStyle,
              options: [
                { label: (0, import_i18n2.__)("Default", "nextora"), value: "default" },
                { label: (0, import_i18n2.__)("Stacked", "nextora"), value: "stacked" },
                { label: (0, import_i18n2.__)("Framed", "nextora"), value: "framed" }
              ],
          ...
          iconSource === "theme" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.RangeControl,
            {
              label: (0, import_i18n2.__)("Stroke width", "nextora"),
              value: strokeWidth,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.SelectControl,
            {
              label: (0, import_i18n2.__)("Alignment", "nextora"),
              value: iconAlign,
              options: [
              ...
              ...iconSource === "theme" ? [
                {
                  ...
                  label: (0, import_i18n2.__)("Icon color", "nextora")
                }
              ] : [],
              ...iconStyle === "stacked" ? [
                {
                  ...
                  label: (0, import_i18n2.__)("Background color", "nextora")
                }
              ] : [],
              ...iconStyle === "framed" ? [
                {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components2.PanelBody, { title: (0, import_i18n2.__)("Link", "nextora"), initialOpen: false, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ...
          "" !== linkUrl.trim() && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            import_components2.SelectControl,
            {
              label: (0, import_i18n2.__)("Open in", "nextora"),
              value: linkTarget,
              options: [
                { label: (0, import_i18n2.__)("Same tab", "nextora"), value: "_self" },
                { label: (0, import_i18n2.__)("New tab", "nextora"), value: "_blank" }
              ],
              onChange: (value) => setAttributes({
                linkTarget: value
              })
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          ...
          {
            title: (0, import_i18n2.__)("Accessibility", "nextora"),
            initialOpen: false,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                import_components2.TextControl,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                import_components2.TextControl,
                {
                  label: (0, import_i18n2.__)("Extra CSS class", "nextora"),
                  value: cssClass,
                  onChange: (value) => setAttributes({ cssClass: value })
                }
              ),
              showLinkAriaWarning && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components2.Notice, { status: "warning", isDismissible: false, children: (0, import_i18n2.__)(
