...
/**
 * Editor-only assets for nextora/advanced-icon block.
 *
 * @package Nextora
 */
 ...
 */
function nextora_advanced_icon_block_editor_assets(): void {
	$handle = 'nextora-advanced-icon-editor-script';
...
add_action( 'enqueue_block_editor_assets', 'nextora_advanced_icon_block_editor_assets', 100 );
