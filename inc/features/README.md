...
Each subfolder groups **all PHP** for one user-facing feature (load order, hooks, template helpers). Front-end **CSS/TS** for the same feature usually stay under `resources/css/modules/` and `resources/ts/lib/`; the feature README points to those paths.
